var productList = [
  ...
  function getInfo() {
   ...
   for(var item=0;item<productList.length;item++){
     ...
     var div_tag=document.createElement('div')
       ...
       var detail_tag=document.createElement('div')
       detail_tag.className="detail_box"
       var div_Img_tag=document.createElement('div')
  
         for (var j in productList[item]) {
  ...
  // console.log(productList[item])
   img_tag.src=productList[item][j]
   
    img_tag.className="product_img";
    div_Img_tag.appendChild(img_tag)
    div_Img_tag.className="product_img"
    //div_tag. insertBefore(img_tag,div_tag.children[0])
   div_tag.appendChild(div_Img_tag)
      ...
      p_tag=document.createElement('h3')
      p_tag.className="item_name"
      p_tag.innerHTML=productList[item][j]
       detail_tag.appendChild(p_tag)
            detail_tag.className="detail_box"
       div_tag.appendChild(detail_tag)
       console.log(detail_tag)
       
    } 
           else if(j=="brand"){
      p_tag=document.createElement('h4')
      p_tag.className="item_brand"
      p_tag.innerHTML=productList[item][j]
           detail_tag.className="detail_box"
          detail_tag.appendChild(p_tag)
       div_tag.appendChild(detail_tag)
      ...
      p_tag=document.createElement('h5')
      p_tag.className="item_price"
      p_tag.innerHTML= "RS "+productList[item][j]
     ...
     if(!flag){
       ...
       var a= document.getElementById("clothing").append(div_tag)
     }else{
       document.getElementById("Acessories").append(div_tag)
     }
     
     //div_tag.children[1].className="abc"
   }
